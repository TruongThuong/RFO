...
namespace RFO.Website.Areas.Admin.Controllers
{
    ...
    /// </summary>
    public class PromotionManagementController : AbstractAdminController
    {
        ...
        {
            return this.RenderPartialViewToString("~/Areas/Admin/Views/PromotionManagement/_PartialDetail.cshtml", id);
        }
        ...
        protected override string GetRecordsViewTemplate()
        {
            ...
            return this.RenderPartialViewToString("~/Areas/Admin/Views/PromotionManagement/_PartialList.cshtml", viewModel);
        }
