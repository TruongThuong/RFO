...
{
    /// <summary>
    /// The controller takes responsibility to handle requests regardless TableOrder management
    /// </summary>
    public class TableOrderManagementController : AbstractAdminController
    {
        ...
        {
            return this.RenderPartialViewToString("~/Areas/Admin/Views/TableOrderManagement/_PartialDetail.cshtml", id);
        }
        ...
        protected override string GetRecordsViewTemplate()
        {
            ...
            return this.RenderPartialViewToString("~/Areas/Admin/Views/TableOrderManagement/_PartialList.cshtml", viewModel);
        }
