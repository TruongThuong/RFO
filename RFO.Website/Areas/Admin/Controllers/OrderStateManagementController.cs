...
namespace RFO.Website.Areas.Admin.Controllers
{
    ...
    /// </summary>
    public class OrderStateManagementController : AbstractAdminController
    {
        ...
        {
            return this.RenderPartialViewToString("~/Areas/Admin/Views/OrderStateManagement/_PartialDetail.cshtml", id);
        }
        ...
        protected override string GetRecordsViewTemplate()
        {
            ...
            return this.RenderPartialViewToString("~/Areas/Admin/Views/OrderStateManagement/_PartialList.cshtml", viewModel);
        }
