...
namespace RFO.Website.Areas.Admin.Controllers
{
    ...
    /// </summary>
    public class TableManagementController : AbstractAdminController
    {
        ...
        {
            return this.RenderPartialViewToString("~/Areas/Admin/Views/TableManagement/_PartialDetail.cshtml", id);
        }
        ...
        protected override string GetRecordsViewTemplate()
        {
            ...
            return this.RenderPartialViewToString("~/Areas/Admin/Views/TableManagement/_PartialList.cshtml", viewModel);
        }
