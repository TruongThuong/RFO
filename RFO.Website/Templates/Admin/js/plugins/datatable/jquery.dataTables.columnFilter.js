...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateRangeInput(oTable) {
            ...
            var from = $('<input type="text" placeholder="From" class="number_range_filter" id="' + sFromId + '" rel="' + i + '" style="width: 40%"/>');
            th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" placeholder="To" class="number_range_filter" id="' + sToId + '" rel="' + i + '" style="width: 40%; margin-left: 10px;"/>');
            th.append(to);
        ...
        return this.each(function () {
            ...
            //var numCell = $(aoFilterCells).length;
